    ...
    UserServiceOptionsInterface
{
    ...
    public function setPusherAppKey($pusherAppKey)
    {
    ...
    public function setPusherAppSecret($pusherAppSecret)
    {
    	$this->pusherAppSecret = $pusherAppSecret;
    }
    
    public function getPusherAppSecret()
    {
    	return $this->pusherAppSecret;
    }
    ...
    public function setPaypalMode($paypalMode)
    {
    ...
    public function setPaypalApiUsername($paypalApiUsername)
    {
    ...
    public function setPaypalApiPassword($paypalApiPassword)
    {
    ...
    public function setPaypalApiSignature($paypalApiSignature)
    {
