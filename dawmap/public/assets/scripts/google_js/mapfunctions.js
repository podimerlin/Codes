...
console.log("Lat: "+$pointLat+"&Lng: "+$pointLong+" eastBound:"+$eastBound+" westBound:"+$westBound+" inLong:"+$inLong);
...
function distanceMarker(lat1,lon1,lat2,lon2) {
...
function displayMarker(circle, gmarkers) {
    var rPosition = circle.get('position');
    var rDistance = circle.get('distance');
    for (var i=0; i<gmarkers.length; i++) {
        var mPosition = gmarkers[i].getPosition();
...
function DistanceWidget(map) {
    ...
    var marker = new google.maps.Marker({
        draggable: true,
        icon: {
            url: mapfunctions_vars.path+'/move.png'
        },
        cursor: 'move',
        title: 'Move me!',
        raiseOnDrag: false
...
RadiusWidget.prototype.addSizer_ = function () {
    var sizer = new google.maps.Marker({
        draggable: true,
        icon: {
            url: mapfunctions_vars.path+'/drag.png'
        },
        cursor: 'e-resize',
        title: 'Drag me!',
        raiseOnDrag: false
  ...
  function map_cluster(){
       if(mapfunctions_vars.user_cluster==='yes'){
        clusterStyles = [
            ...
            url: mapfunctions_vars.path+'/cloudA.png',
            height: 48,
            width: 48,
            textSize:15,
        ...
        mcOptions = {gridSize: 50,
                    ignoreHidden:true, 
                    maxZoom: parseInt( mapfunctions_vars.zoom_cluster, 13), 
                    styles: clusterStyles
                };
        mcluster = new MarkerClusterer(map, gmarkers, mcOptions);
        mcluster.setIgnoreHidden(true);
        
        google.maps.event.addListener(mcluster, "mouseover", function (c) {
            c.clusterIcon_.div_.lastChild.style.color='#3c90be';
            c.clusterIcon_.div_.firstChild.src=mapfunctions_vars.path+'/cloudB.png';
        });
        
        google.maps.event.addListener(mcluster, "mouseout", function (c) {
            c.clusterIcon_.div_.lastChild.style.color='#ffffff';
            c.clusterIcon_.div_.firstChild.src=mapfunctions_vars.path+'/cloudA.png';
        });
    }
